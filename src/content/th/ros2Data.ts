...
export const ROS2_COURSE_TH: CourseData = {
  "id": "ros2-jazzy",
...
export const ROS2_LESSONS_TH: Record<string, LessonContent> = {
  "01-introduction": {
    "id": "ros2-01",
    "slug": "01-introduction",
    ...
    "quiz": [
      {
        ...
        "options": [
          {
            "id": "a",
            "text": "จำเป็น ต้องเปิดทิ้งไว้ในเทอร์มินัลแยกต่างหาก"
          },
          {
            "id": "b",
            "text": "ไม่จำเป็น ROS 2 ใช้มิดเดิลแวร์ DDS แบบกระจายศูนย์ ค้นหากันเองแบบอัตโนมัติ"
          },
          {
            "id": "c",
            "text": "จำเป็นเฉพาะเมื่อเขียนโหนดด้วยภาษา Python"
          },
          {
            "id": "d",
            "text": "จำเป็นเฉพาะเมื่อเชื่อมต่อหุ่นยนต์หลายตัว"
          }
        ],
        "correctAnswer": "b",
      ...
      },
      {
        ...
        "options": [
          {
            "id": "a",
            "text": "ช่วยให้คอมไพเลอร์ C++ ทำงานเร็วขึ้น"
          },
          {
            "id": "b",
            "text": "ช่วยแยกวงการสื่อสารของ DDS ไม่ให้หุ่นยนต์ได้รับคำสั่งจากกลุ่มหรือทีมอื่นบน Wi-Fi เดียวกัน"
          },
          {
            "id": "c",
            "text": "จำเป็นสำหรับการต่ออายุไลเซนส์ Ubuntu"
          },
          {
            "id": "d",
            "text": "ช่วยเร่งความเร็วในการชาร์จแบตเตอรี่หุ่นยนต์"
          }
        ],
        "correctAnswer": "b",
  ...
  "02-installation": {
    ...
    "prevLesson": {
      "title": "01. สถาปัตยกรรม ROS 2 และ DDS",
      "slug": "01-introduction"
    },
    "nextLesson": {
    ...
    "quiz": [
      {
        ...
        "options": [
          {
            "id": "a",
            "text": "ช่วยแปลงโค้ด Python เป็นไฟล์ C++ ไบนารี"
          },
          {
            "id": "b",
            "text": "ช่วยเชื่อมโยงไฟล์ต้นฉบับ ทำให้การแก้ไขโค้ดมีผลทันทีโดยไม่ต้องรัน colcon build ซ้ำ"
          },
          {
            "id": "c",
            "text": "ช่วยให้มอเตอร์หุ่นยนต์หมุนเร็วขึ้นสองเท่า"
          },
          {
            "id": "d",
            "text": "ช่วยข้ามขั้นตอนการทดสอบโค้ดทั้งหมด"
          }
        ],
        "correctAnswer": "b",
    ...
    "quiz": [
      {
        ...
        "options": [
          {
            "id": "a",
            "text": "สั่งให้ล้อหุ่นยนต์หมุน 360 องศา"
          },
          {
            "id": "b",
            "text": "คอยกระจายงานและรักษาสถานะให้โหนดรอรับ Callback และ Timer ใน Event Loop"
          },
          {
            "id": "c",
            "text": "แปลงโค้ดภาษา Python เป็นภาษา C++"
          },
          {
            "id": "d",
            "text": "เปิดไฟ LED ด้านหน้าของหุ่นยนต์"
          }
        ],
        "correctAnswer": "b",
    ...
    "quiz": [
      {
        ...
        "options": [
          {
            "id": "a",
            "text": "การสตรีมภาพจากกล้องความถี่ 30 FPS"
          },
          {
            "id": "b",
            "text": "การสั่งคำสั่งที่ต้องการคำยืนยันผลการทำงานทันที เช่น การสั่งรีเซ็ตพิกัดตำแหน่งหุ่นยนต์"
          },
          {
            "id": "c",
            "text": "การส่งคำสั่งความเร็วเดินหน้าของมอเตอร์ล้ออย่างต่อเนื่อง"
          },
          {
            "id": "d",
            "text": "การกระจายข้อมูลแผนที่ LiDAR ไปยังผู้รับหลายๆ เครื่องพร้อมกัน"
          }
        ],
        "correctAnswer": "b",
    ...
    "quiz": [
      {
        ...
        "options": [
          {
            "id": "a",
            "text": "ต้องประกาศพารามิเตอร์ด้วยคำสั่ง self.declare_parameter() เสียก่อน"
          },
          {
            "id": "b",
            "text": "ต้องรีสตาร์ตเครื่องคอมพิวเตอร์ใหม่"
          },
          {
            "id": "c",
            "text": "ต้องสร้าง Action Server เพิ่มเติม"
          },
          {
            "id": "d",
            "text": "ต้องตั้งค่า Environment Variable ของระบบปฏิบัติการ"
          }
        ],
        "correctAnswer": "a",
    ...
    "quiz": [
      {
        ...
        "options": [
          {
            "id": "a",
            "text": "Gazebo Harmonic ร่วมกับแพ็กเกจ ros_gz (ros_gz_bridge)"
          },
          {
            "id": "b",
            "text": "Gazebo Classic 11 ร่วมกับ gazebo_ros"
          },
          {
            "id": "c",
