...
const targetPath = path.join(__dirname, '../src/components/simulator/ROS2InstallationLab.tsx');
...
export function ROS2InstallationLab() {
  ...
  const executeCommand = (cmd: string) => {
    ...
    if (trimmed.includes("apt install") && trimmed.includes("ros-jazzy-desktop")) {
      ...
      // Simulate apt install with progress animation
    ...
    if (trimmed === "ros2" || trimmed === "ros2 --help") {
      ...
      appendLog("usage: ros2 [-h] [--use-python-logging] Call \`ros2 <command> -h\` for more detailed usage.");
      appendLog("");
      appendLog("Commands:");
  ...
  return (
    <div className="my-10 rounded-2xl border-2 border-redbrick-600/30 bg-charcoal-950 text-white overflow-hidden shadow-2xl font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
        {/* Left Col: 10 Sequential Installation Steps (7 Cols) */}
            ...
            return (
              <div
                ...
                className={`p-3.5 rounded-xl border transition-all ${
                  isDone
                    ? "bg-green-950/15 border-green-600/40"
        ...
        {/* Right Col: Interactive Stateful Terminal (5 Cols) */}
...
console.log("ROS2InstallationLab created successfully!");
