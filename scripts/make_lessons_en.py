    ...
    "quiz": [
      {
        ...
        "options": [
          {"id": "a", "text": "Yes, it must run in a background terminal"},
          {"id": "b", "text": "No, ROS 2 uses decentralized peer-to-peer DDS discovery"},
          {"id": "c", "text": "Only when running Python nodes"},
          {"id": "d", "text": "Only when multiple robots are connected"}
        ],
        "correctAnswer": "b",
      ...
      },
      {
        ...
        "options": [
          {"id": "a", "text": "It accelerates C++ compiler speed"},
          {"id": "b", "text": "It isolates DDS traffic so robots do not receive commands from other teams"},
          {"id": "c", "text": "It is required for Ubuntu licensing"},
          {"id": "d", "text": "It configures battery charging rate"}
        ],
        "correctAnswer": "b",
        "explanation": "ROS_DOMAIN_ID partitions DDS multicast discovery, preventing robots from cross-talking on shared networks."
      }
    ],
    "nextLesson": {"title": "02. Installation on Ubuntu 24.04", "slug": "02-installation"}
  },
...
```""",
    ...
    "prevLesson": {"title": "01. Architecture & DDS", "slug": "01-introduction"},
    "nextLesson": {"title": "03. ROS 2 CLI", "slug": "03-cli"}
  },
...
- **`ros2 action list`**: Lists long-running action goals (e.g. Nav2 navigation).""",
    ...
    "prevLesson": {"title": "02. Installation", "slug": "02-installation"},
    "nextLesson": {"title": "04. Workspaces & colcon", "slug": "04-workspace"}
  },
...
This creates symbolic links pointing directly to your Python source files in `src/`. When you modify an algorithm or script, your changes take effect **immediately** without requiring another `colcon build`!""",
    ...
    "quiz": [
      {
        ...
        "options": [
          {"id": "a", "text": "It converts Python scripts into encrypted C++ binaries"},
          {"id": "b", "text": "It creates symbolic links so Python edits apply immediately without re-building"},
          {"id": "c", "text": "It runs the robot motor at double speed"},
          {"id": "d", "text": "It bypasses all unit tests"}
        ],
        "correctAnswer": "b",
    ...
    "prevLesson": {"title": "03. ROS 2 CLI", "slug": "03-cli"},
    "nextLesson": {"title": "05. Nodes & Python rclpy", "slug": "05-nodes"}
  },
    ...
    "quiz": [
      {
        ...
        "options": [
          {"id": "a", "text": "It spins the physical robot wheels 360 degrees"},
          {"id": "b", "text": "It keeps the node alive and dispatches incoming callbacks and timers in an event loop"},
          {"id": "c", "text": "It compiles the Python code into C++"},
          {"id": "d", "text": "It turns on the robot's front LED"}
        ],
        "correctAnswer": "b",
        "explanation": "rclpy.spin is the core event loop dispatcher that processes timers, subscriptions, and service requests."
      }
    ],
    "prevLesson": {"title": "04. Workspaces & colcon", "slug": "04-workspace"},
    "nextLesson": {"title": "06. Topics & Pub/Sub", "slug": "06-topics"}
  },
...
- **Reliable**: Guarantees delivery through retransmissions (used for mission-critical commands like `/cmd_vel` or emergency stops).""",
    ...
    "prevLesson": {"title": "05. Nodes & Python rclpy", "slug": "05-nodes"},
    "nextLesson": {"title": "07. Services & Clients", "slug": "07-services"}
  },
    ...
    "quiz": [
      {
        ...
        "options": [
          {"id": "a", "text": "When streaming 30 FPS camera video"},
          {"id": "b", "text": "When an immediate confirmation/response is required for an action like resetting odometry"},
          {"id": "c", "text": "When sending continuous /cmd_vel motor commands"},
          {"id": "d", "text": "When broadcasting LiDAR range clouds to multiple subscribers"}
        ],
        "correctAnswer": "b",
        "explanation": "Services are designed for discrete request-response transactions requiring confirmed execution."
      }
    ],
    "prevLesson": {"title": "06. Topics & Pub/Sub", "slug": "06-topics"},
    "nextLesson": {"title": "08. Actions & Nav2", "slug": "08-actions"}
  },
...
5. **Result Service**: Returns final completion outcome when goal is reached.""",
    ...
    "prevLesson": {"title": "07. Services & Clients", "slug": "07-services"},
    "nextLesson": {"title": "09. Parameters", "slug": "09-parameters"}
  },
    ...
    "quiz": [
      {
        ...
        "options": [
          {"id": "a", "text": "Declare the parameter using self.declare_parameter()"},
          {"id": "b", "text": "Restart the computer"},
          {"id": "c", "text": "Create an action server"},
          {"id": "d", "text": "Export a system environment variable"}
        ],
        "correctAnswer": "a",
        "explanation": "ROS 2 requires nodes to declare parameters with a default value and optional descriptor before access."
      }
    ],
    "prevLesson": {"title": "08. Actions & Nav2", "slug": "08-actions"},
    "nextLesson": {"title": "10. Launch Files", "slug": "10-launch"}
  },
...
```""",
    ...
    "prevLesson": {"title": "09. Parameters", "slug": "09-parameters"},
    "nextLesson": {"title": "11. Gazebo Harmonic", "slug": "11-gazebo-harmonic"}
  },
...
```""",
    ...
    "quiz": [
      {
        ...
        "options": [
          {"id": "a", "text": "Gazebo Harmonic with ros_gz (ros_gz_bridge)"},
          {"id": "b", "text": "Gazebo Classic 11 with gazebo_ros"},
    ...
    "prevLesson": {"title": "10. Launch Files", "slug": "10-launch"}
  }
}
